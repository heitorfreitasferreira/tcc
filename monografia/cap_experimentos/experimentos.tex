...
O ganho de qualidade do ACO vem acompanhado de maior custo computacional. Nas instâncias de 100 pontos, o tempo médio de otimização do ACO ficou em torno de \TempoOtimizacaoACOCemMedioSegundos{}, enquanto a maior média por instância do GA foi \TempoOtimizacaoGAMaxCemMs{} e a do PSO foi \TempoOtimizacaoPSOMaxCemMs{}. A \autoref{tab:tempo-100} mostra as razões por instância.
