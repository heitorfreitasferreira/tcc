...
As tabelas abaixo incluem os valores por instância para todas as 30 instâncias e métodos avaliados. As tabelas do corpo principal (Capítulo~\ref{experimentos}) apresentam versões resumidas ou agregadas.
