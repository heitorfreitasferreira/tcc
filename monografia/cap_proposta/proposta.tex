...
O pipeline experimental foi executado sobre 30 instâncias sintéticas, com tamanhos 10, 11, 12, 13, 14, 15, 20, 30, 50 e 100 pontos, três variantes por tamanho. Para GA, PSO e ACO, foram usadas 51 sementes, de 0 a 50. A busca exaustiva tem execução determinística e aparece apenas nas 18 instâncias pequenas. O lower bound também é determinístico e foi executado nas 30 instâncias.
...
O conjunto final contém 4638 arquivos de resumo: 1530 para GA, 1530 para PSO, 1530 para ACO, 30 para lower bound e 18 para busca exaustiva. A mesma quantidade de arquivos de evolução e de tempo foi registrada, permitindo analisar qualidade final, trajetória de convergência e custo computacional.
